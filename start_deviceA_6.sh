...
# ================= 實驗 1_6 變數配置 =================
EFO_APP="EFO_server_lru:app"
CTRL_APP="control_node_server_lru:app"
export LORA_METADATA_PATH="./information/lora_metadata_without_substitutes.json"
export DISK_CAPACITY_GB="2"
export DISPATCH_STRATEGY="greedy"
# =====================================================

export PYTORCH_CUDA_ALLOC_CONF=expandable_segments:True
export LOG_PATH="./experiment_deviceA_logs_6"
export SIMULATION="0"
mkdir -p "$LOG_PATH"
