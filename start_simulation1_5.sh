...
# Logs
export LOG_PATH="./experiment_single_cluster_2nodes5_logs"
...
export DISK_CAPACITY_GB=2.2       # 每個 Cluster 硬碟的 LoRA 儲存容量上限 (GB)
...
start() {
  ...
  uvicorn control_node_server_dlora:app --host 0.0.0.0 --port "$CTRL1_PORT" \
