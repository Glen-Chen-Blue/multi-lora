...
# Logs
export LOG_PATH="./experiment_single_cluster_2nodes6_logs"
...
export DISK_CAPACITY_GB=2       # 每個 Cluster 硬碟的 LoRA 儲存容量上限 (GB)

export DISPATCH_STRATEGY="greedy"   # Dispatch 策略：random, lru, 或 custom
# ==================================================
# 🌐 Port Configuration
# ==================================================
